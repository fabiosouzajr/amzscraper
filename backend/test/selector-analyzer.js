...
exports.SelectorAnalyzer = void 0;
...
class SelectorAnalyzer {
     ...
     */
    async testSelector(page, selector, attribute) {
        try {
     ...
     */
    async analyzeProductCategory(asin) {
     ...
     */
    async testSelectors(asin, selectors, attribute) {
        if (!this.browser || !this.context) {
            await this.initialize();
        }
        const page = await this.context.newPage();
     ...
     */
    async takeScreenshot(asin, filename) {
        if (!this.browser || !this.context) {
            await this.initialize();
        }
        const page = await this.context.newPage();
...
exports.SelectorAnalyzer = SelectorAnalyzer;
// CLI usage
async function main() {
